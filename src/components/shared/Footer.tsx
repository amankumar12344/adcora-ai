      ...
      <div className="page-container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 text-sm text-muted">
            ...
            {/* WhatsApp / Phone */}
            <div className="flex items-start gap-3 group">
              <svg className="h-4.5 w-4.5 mt-0.5 text-emerald-400 fill-emerald-400 shrink-0 transition-colors group-hover:fill-white group-hover:text-white" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <a href="https://wa.me/918360607130?text=Hi%20AdcoraAI" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">
                  +91 83606 07130
                </a>
              </div>
            </div>
          ...
          <div className="pt-2">
            ...
            <div className="flex gap-4 text-muted">
              ...
              <a href="https://www.linkedin.com/in/aman-kumar-566403205" target="_blank" rel="noreferrer" className="hover:text-white transition-colors" aria-label="LinkedIn">
